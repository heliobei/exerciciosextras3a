...
function Footer() {
  return (
    <footer className="bg-gradient-to-br from-blue-500 to-[#21BDC6]  min-h-[240px] flex flex-col md:flex-row items-center justify-between px-6 py-8 gap-6 md:gap-0 md:py-6">
      {/* Logo */}
